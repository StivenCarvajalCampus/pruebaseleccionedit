import delete_team from "./deleteDatateam.js"
import edit_team from  "./editDatateam.js"

export default {
    ws: new Worker("js/workers/wsGetteam.js", {type:"module"}),
    printData(){
            ...
            this.ws.addEventListener("message", (e) => {
                ...
                delete_button.forEach((element) => {
                  element.addEventListener("click", () => {
                    delete_team.getEvent(element)
                  });
                });
                edit_button.forEach((element) => {
                    element.addEventListener("click", () => {
                      edit_team.editEvent(element)
                      dialog.showModal();
                    });
                  });
